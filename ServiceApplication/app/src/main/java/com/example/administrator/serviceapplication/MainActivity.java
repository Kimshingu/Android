...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btnStart1, btnStart2, btnStart3, btnStart4,
            btnPrint, btnStop1, btnStop2, btnStop3, btnStop4, btnNext;
    TextView textView;
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        @Override
        // MyBoundService.onBind() 메소드가 리턴값이 service라는 파라미터로
        // 전달된다.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 서비스 로직이 계속 수행중인 상태에서 액티비티가 사용자의 요청을
        // 접수하여 다른 행동을 수행할 수 있다.
